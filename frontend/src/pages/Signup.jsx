      ...
      <Box sx={{
        ...
        <Box sx={{ position: 'relative', textAlign: 'center', zIndex: 1, maxWidth: 420 }}>
          ...
          <Typography sx={{ color: '#9CA3AF', mb: 5, fontSize: 17, lineHeight: 1.6 }}>
            Join thousands of people sharing their stories and ideas every day.
          </Typography>

          {[
            { icon: '🚀', text: 'Get started in seconds' },
            { icon: '🌍', text: 'Connect with everyone' },
            { icon: '💜', text: 'Like, comment and engage' },
          ].map((f) => (
            <Box key={f.text} sx={{
      ...
      <Box sx={{
        ...
        <Box sx={{
          ...
          <Typography variant="body2" sx={{ color: '#6B7280', mb: 3.5 }}>
            Join PulseBoard and start sharing today
          </Typography>
          ...
          <Box component="form" onSubmit={handleSubmit} sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
            <TextField label="Full Name" name="name"
              value={form.name} onChange={handleChange} required fullWidth sx={inputSx} />
